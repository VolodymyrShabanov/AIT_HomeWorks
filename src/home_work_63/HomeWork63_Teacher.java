 ...
 */
public class HomeWork63_Teacher {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        Matcher matcherT2 = Pattern.compile("\\bre[a-zA-Z]*")
                .matcher("I need to rewrite and reread these re reports.");
        ...
        */
        ...
        Matcher matcherT4 = Pattern.compile("\\b[a-zA-Z]\\w{1,2}[\\w%#!&*]?\\.?[\\w%#!&*]+@[a-zA-Z]{3,}\\.?[a-zA-Z]{3,}\\.[a-zA-Z]{2,3}\\b")
                .matcher("Мои контакты: email@example.com, test.email@domain.ru.");
